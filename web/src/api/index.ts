 ...
 * reads are real now; `getNodeLogs` and `getCoordinatorLogs` explicitly report unavailable because
 * their routes still answer `501 UNIMPLEMENTED` server-side. Keep the mock compiling — it also backs tests and
