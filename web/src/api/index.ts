 ...
 * reads are real now; `getSession`, `getNodeUtilization`, `getNodeHistory`,
 * `getNodeLogs`, `getCoordinatorLogs` stay on the mock because their routes
 * still answer `501 UNIMPLEMENTED` server-side. Keep the mock compiling —
