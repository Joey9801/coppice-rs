...
# the daemon writes nothing under it. Cluster-owned machine-plane material
# lives under the role's own state directory instead
# (/var/lib/coppice/pki or /var/lib/coppice-agent/pki), created by
# StateDirectory=.
