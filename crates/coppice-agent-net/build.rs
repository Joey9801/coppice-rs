//! Generates the tonic service glue for the agent↔coordinator session
//! transport (`coppice.agent.v1.AgentService`, ADR 0009/0011).
//!
...
//! the only output is the client/server code for the service, which
